...
function InsertCard(props) {
  ...
  const price = parseFloat(totalPrice / userCard.installments)
    .toFixed(2)
    .replace(".", ",");
    ...
    <Card>
      ...
      <Form>
        ...
        <Input
          ...
          required
          value={userCard.expireDate}
          onChange={(e) =>
            setUserCard({ ...userCard, expireDate: e.target.value })
          }
        />
        ...
        <Input
          ...
          value={userCard.cvv}
          onChange={(e) =>
            setUserCard({ ...userCard, cvv: parseInt(e.target.value) })
          }
        />

        <Installments
          value={userCard.installments}
          onChange={(e) =>
            setUserCard({ ...userCard, installments: parseInt(e.target.value) })
          }
        >
        ...
        <Input
          ...
          onChange={(e) =>
            setUserCard({ ...userCard, fullName: e.target.value })
          }
        />
      ...
      <Finalize>
        <p>
          Total : {userCard.installments}x R$ {price}
        </p>
